"""
Publication-grade Figure 1: Context-Stress Evaluation and PTL Framework
...
def create_figure1(output_dir=None, format="both"):
    ...
    # Main title
    fig.suptitle("Context-Stress Evaluation and Perturbation Transportability Reliability",
