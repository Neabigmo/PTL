...
GLOBAL_GENE_SPACE_PATH = TABLES_DIR / "phase05_global_gene_intersection_7880.txt"
...
def parse_args() -> argparse.Namespace:
    ...
    build_manifest = subparsers.add_parser("build-run-matrix", help="Build the 210-run campaign manifest.")
...
def run_single(
    ...
    gene_space_policy = "global_intersection_7880" if split_payload["split_family"] in {"dataset_heldout_split", "external_holdout"} else "native"
