...
\centering
\tiny
\caption{Prespecified model comparison under leave-one-unordered-context-pair-out validation. $\Delta$MAE is positive when a model improves on the stated reference; intervals are 2,000 unordered-pair block-bootstrap diagnostics. M4 is exploratory because its decomposition features are not a superset of M3.}
