...
deterministic Kendall comparison of the two mean rankings records no
...
are independent and identically distributed within each context, the frozen
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/supplementary/s1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/supplementary/s2.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/supplementary/s3.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/supplementary/s4.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.96\textwidth]{figures/supplementary/dadj_inference_calibration.pdf}
...
the preregistered $256$--$512$ GELU architecture, dropout $0.1$, AdamW and a
...
The resulting five-family profile, including strict source-frozen GEARS, is evaluated on the same frozen labels,
genes, contexts and metrics. The canonical family comparison uses the same
18 directed transfer--metric rows and the same full-size raw-cell estimator;
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/supplementary/s5_upgrade_v2.pdf}
...
$0.818$ and $0.700$. Thus the cross-donor distance did not exceed the
same-donor distance on this magnitude-rank surface. We retain this as neutral
external evidence, not as a negative biological claim. A within-line cell
...
cell is on a context-unique plate. This fails the preregistered
...
The scientific regeneration path starts from the canonical manifest tables, fixed splits and resampling settings, and rebuilds the four main figures, Supplementary Figs.~S1--S5, and the compact supplementary tables. The V3 comparator, Feng and adaptive ledgers are generated from their corresponding scripts and are linked to the tables above; they do not alter the canonical main figures. The anonymous repository documents the executable commands and data lineage. Large raw H5AD/NPZ inputs remain external to the manuscript tree; the reviewable CSV/JSON products expose the values used in figures and tables.

\paragraph{Code and data availability.}
The anonymized core release is available at
\url{https://github.com/Neabigmo/PTL/tree/iclr2027-anonymous-core} and contains
