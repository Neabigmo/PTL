...
unordered context-pair blocks. A matched source-only RBF sensitivity, the
prospective feature ladder, the active-audit replay and external model controls
are reported in the Supplement and are not pooled into the primary claim; the
...
The anonymous code release at
\url{https://github.com/Neabigmo/PTL/tree/iclr2027-anonymous-core}
...
figures, Supplementary Figs.~S1--S4, and the compact tables. Appendices A, B,
...
Zenodo record (\url{https://zenodo.org/records/13350497}); the repository
